...
There are multiple possible validation techniques, which are describing in the following:

1. [[LOOCV (*Leave-one out Cross Validation*)]]
2. [[K-fold Cross-validation]]
3. [[Bootstrap method]] (this one is primarily used to assess the variance of a specific statistic using simulation)